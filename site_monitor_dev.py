...
# setting up another browser to follow a link
# TODO: change this..?
browser_duo = webdriver.Firefox(executable_path=geckodriver, options=options)
...
# note : create a formatter
# create file formatter
# file_handler.setFormatter('')

'''
some important notes need to go here
'''
